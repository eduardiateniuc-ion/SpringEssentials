...
public class AccountClientTests {
    ...
    public void listAccounts() {
        ...
        Account[] accounts =
                restTemplate.getForObject("/accounts", Account[].class);

        assertThat(accounts.length >= 21).isTrue();
        assertThat(accounts[0].getName())
                .isEqualTo("Keith and Keri Donald");

        assertThat(accounts[0].getBeneficiaries().size())
                .isEqualTo(2);

        assertThat(accounts[0]
                .getBeneficiary("Annabelle")
    ...
    public void getAccount() {
        ...
        assertThat(account.getBeneficiaries().size())
                .isEqualTo(2);
    ...
    public void createAccount() {
        ...
        String number =
                String.format("12345%4d", random.nextInt(10000));
        ...
        assertThat(retrievedAccount.getNumber())
                .isEqualTo(account.getNumber());

        Beneficiary accountBeneficiary =
                account.getBeneficiaries().iterator().next();

        Beneficiary retrievedAccountBeneficiary =
                retrievedAccount.getBeneficiaries().iterator().next();

        assertThat(retrievedAccountBeneficiary.getName())
                .isEqualTo(accountBeneficiary.getName());

        assertThat(retrievedAccount.getEntityId())
                .isNotNull();
    }
    ...
    public void addAndDeleteBeneficiary() {
        ...
        assertThat(newBeneficiary.getName())
                .isEqualTo("David");
